...
return array(
    ...
    //用户登录
    'userLogin' => array(
        'file' => 'serviceUcenter.php','class' => 'ServiceUcenter'
    ),
     ...
     */
    // 后台--获取股权日志
    'getScocksLogList' => array(
        'file' => 'serviceAdmin.php', 'class' => 'ServiceAdmin'
    ),

    // 后台--获取vip消费日志
    'getRevisitLogList' => array(
        'file' => 'serviceAdmin.php', 'class' => 'ServiceAdmin'
    ),

    // 后台--用户等级变更日志
    'getLevelUpgradeList' => array(
        'file' => 'serviceAdmin.php', 'class' => 'ServiceAdmin'
    ),

    // 后台--用户邀请统计
    'getUserInvitedList' => array(
        'file' => 'serviceAdmin.php', 'class' => 'ServiceAdmin'
    ),

    // 后台--获取拨比统计
    'getDialOutRate' => array(
        'file' => 'serviceAdmin.php', 'class' => 'ServiceAdmin'
    ),

    // 后台--获取实名列表
    'getRealNameList' => array(
        'file' => 'serviceAdmin.php', 'class' => 'ServiceAdmin'
    ),
    ...
    // 计算ydui购物车数据
    'getYduiCartFormat' => array(
        'file' => 'serviceGoods.php', 'class' => 'ServiceGoods'
    ),

    // 计算ydui商品价格
    'getYduiGoodsCount' => array(
        'file' => 'serviceGoods.php', 'class' => 'ServiceGoods'
    ),
    ...
    // 获取图形验证码
    'getCaptcha' => array(
        'file' => 'serviceOther.php', 'class' => 'ServiceOther'
    ),
    ...
    // 验证码
    'getRegMobileCode' => array(
        'file' => 'serviceOther.php', 'class' => 'ServiceOther'
    ),

    // 注册协议
    'getRegAgreement' => array(
        'file' => 'serviceOther.php', 'class' => 'ServiceOther'
    ),
    ...
    // 手机白名单
    'getPhoneWhitelist' => array(
        'file' => 'serviceOther.php', 'class' => 'ServiceOther'
    ),

    // 获取wxAccessToken
    'getWxAccessToken' => array(
        'file' => 'serviceOther.php', 'class' => 'ServiceOther'
    ),
    ...
    // 个人中心--vip消费日志
    'getUcenterRevisitLog' => array(
        'file' => 'serviceUcenter.php', 'class' => 'ServiceUcenter'
    ),

    // 个人中心--股权日志
    'getUcenterStocksLog' => array(
        'file' => 'serviceUcenter.php', 'class' => 'ServiceUcenter'
    ),

    // 个人中心--余额日志
    'getUcenterAccountLog' => array(
        'file' => 'serviceUcenter.php', 'class' => 'ServiceUcenter'
    ),
    ...
    // 个人中心--提现记录
    'getWithdrawLog' => array(
        'file' => 'serviceUcenter.php', 'class' => 'ServiceUcenter'
    ),

    // 个人中心--评论列表
    'getUcenterCommonList' => array(
        'file' => 'serviceUcenter.php', 'class' => 'ServiceUcenter'
    ),

    // 评论--商品详情
    'getCommonDetail' => array(
        'file' => 'serviceUcenter.php', 'class' => 'ServiceUcenter'
    ),
    ...
    // 评论--图片上传
    'uploadCommonImg' => array(
        'file' => 'serviceUcenter.php', 'class' => 'ServiceUcenter'
    ),

    // 评论--提交
    'updateCommonGoods' => array(
        'file' => 'serviceUcenter.php', 'class' => 'ServiceUcenter'
    ),

    // 个人中心--地址列表
    'getUcenterAddressList' => array(
        'file' => 'serviceUcenter.php', 'class' => 'ServiceUcenter'
    ),
    ...
    // 商品收藏
    'goodsFavoriteEdit' => array(
        'file' => 'serviceUcenter.php', 'class' => 'ServiceUcenter'
    ),

    // 商品收藏id数组
    'getGoodsFavoriteIds' => array(
        'file' => 'serviceUcenter.php', 'class' => 'ServiceUcenter'
    ),

    // 商品收藏列表
    'getFavoriteList' => array(
        'file' => 'serviceUcenter.php', 'class' => 'ServiceUcenter'
    ),
    ...
    // 激活会员--获取激活金额
    'getBecomVipAmount' => array(
        'file' => 'serviceUcenter.php', 'class' => 'ServiceUcenter'
    ),

    // 激活会员V2
    'activateMemberV2' => array(
        'file' => 'serviceUcenter.php', 'class' => 'ServiceUcenter'
    ),

    // 实名认证--图片上传
    'uploadRealNamePhoto' => array(
        'file' => 'serviceUcenter.php', 'class' => 'ServiceUcenter'
    ),
    ...
    // 申请售后图片
    'uploadRefundsImg' => array(
        'file' => 'serviceUcenter.php', 'class' => 'ServiceUcenter'
    ),

    // 售后详情
    'getRefundsDetail' => array(
        'file' => 'serviceUcenter.php', 'class' => 'ServiceUcenter'
    ),

    // 用户提交售后物流单
    'updateRefundsFreight' => array(
        'file' => 'serviceUcenter.php', 'class' => 'ServiceUcenter'
    ),

    // 售后物流详情
    'getFreightDetail' => array(
        'file' => 'serviceUcenter.php', 'class' => 'ServiceUcenter'
    ),
    ...
    // 获取验证码
    'getCallCode' => array(
        'file' => 'serviceUcenter.php', 'class' => 'anyCall'
    ),

    // 注册
    'registerCall' => array(
        'file' => 'serviceAnyCall.php', 'class' => 'anyCall'
    ),
